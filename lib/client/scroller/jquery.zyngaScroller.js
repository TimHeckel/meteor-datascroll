            ...
            return this.each(function () {
                ...
                if (!_self.data('zyngaScroller')) {
                    //window.setTimeout(function() {
                        ...
                        var dragCursor = ff ? "-moz-grab" : "url('/images/openhand.cur')" + cursCoords + ", move";
                        _self.css({ cursor: dragCursor });
                        _self.mousedown(function (e) {
                            dragCursor = ff ? "-moz-grabbing" : "url('/images/closedhand.cur')" + cursCoords + ", move";
                            _self.css({ cursor: dragCursor });
                        });
                        _self.mouseup(function (e) {
                            dragCursor = ff ? "-moz-grab" : "url('/images/openhand.cur')" + cursCoords + ", move";
                            _self.css({ cursor: dragCursor });
                        });
