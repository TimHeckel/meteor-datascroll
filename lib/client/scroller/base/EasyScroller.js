...
EasyScroller.prototype.reflow = function (cb) {
    ...
    if (this.options.snapping.enabled) {
        var _dimen = this.options.snapping.dimensions;
        this.scroller.setSnapSize(_dimen.width, _dimen.height);
    }
...
EasyScroller.prototype.bindEvents = function () {
    ...
    if (window.addEventListener) {
        ...
        window.attachEvent("resize", _handleResize);
    }
    ...
    if ('ontouchstart' in window) {
        ...
        var md = function (e) {
            ...
            console.log("MOUSE DOWN ON SCROLLER: " + that.options.enabled);
